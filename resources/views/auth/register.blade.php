            ...
            <div class="row">
                ...
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="mb-4">
                                <h3>Register to <strong>POS-System</strong></h3>
                                <p class="mb-4"></p>
                            </div>
                            <form method="POST" action="{{ route('register') }}">
                                @csrf
                                <div class="form-group firs">
                                ...
                                <a href="/login" style="text-decoration: none"><span class="d-block text-right my-2 text-muted"> Already have an account</span></a>
                            </form>
                        </div>
                    </div>
