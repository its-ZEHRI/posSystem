<x-layout.applayout>
    ...
    <div id="alert">
        ...
        <button id="msg_alert" class="d-none"
            onclick="md.showNotification('top','center','<h4>Enter Data along with the Category...!</h4>','info')"></button>
        <button id="payment_card_alert" class="d-none"
            onclick="md.showNotification('top','center','<h4>Select the Supplier...!</h4>','info')"></button>
        ...
        <div class="row" id="top">
            <div class="col-md-8">
                <form id="data_entry_form">
                    ...
                    <input id="temp_category_field" value="0" type="hidden" name="category_id">
                    <input id="temp_supplier_field" value="0" type="hidden" name="supplier_id">
                    <x-utilities.banner title="Add Products" date="{{ now()->format('d/m/y') }}" subtitle="">
                        <div class="row">
                                        ...
                                        <div class="card-body d-none bg-white rounded w-100 custom-dropdown"
                                            ...
                                            <div id="category_filter" class="b">
                                                <div class="input-group no-border ">
                                                    <input id="" type="text" value="" style=""
                            ...
                            <div class="col-md-4">
                                <div>
                                    <div class="card card-plain mb-0 mt-4 p-0" style="position: relative">
                                        <div id="supplier_card"
                                            class="card-header card-header-primary d-flex justify-content-between align-items-center"
                                            style="padding: 5px 15px 3px 15px">
                                            <h5 style="height: 1.5rem; overflow-y:hidden; width:90%" class="card-title">
                                                Supplier</h5>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input id="temp_p_name_field" type="text" name="product_name"
                            ...
                            <div class="col-md-4">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input id="temp_p_code_field" type="text" name="p_code"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input id="temp_p_price_field" type="text" name="p_price"
                                        class="form-control" value="{{ old('p_price') }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input id="temp_s_price_field" type="text" name="s_price"
                                        class="form-control" value="{{ old('s_price') }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input id="temp_ws_price_field" type="text" name="ws_price"
                                        class="form-control" value="{{ old('ws_price') }}"
                        ...
                        <div class="row">
                            <div class="col-md-3 pt-2">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input id="temp_quantity_field" type="text" name="quantity"
                        ...
                        <hr>
                        <button id="purchase_form_btn" type="submit"
                            class="c-btn c-btn-primary pull-right">Enter</button>
                        <button id="purchase_form_clear_btn"
                            class="c-btn c-btn-secondary pull-right mr-3">Clear</button>
                ...
                <div class="card card-plain">
                    <div class="card-header card-header-primary d-flex justify-content-between lign-items-center">
                        <div>
                            ...
                            <span id="actions_expand" class="actions"><i
                                    class="fa-solid fa-expand d-none"></i></span>
                        </div>
