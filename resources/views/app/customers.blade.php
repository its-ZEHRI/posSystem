<x-layout.applayout>
    ...
    <div class="container-fluid">
                ...
                <x-utilities.banner title="Add Customer" date="{{now()->format('d/m/y ')}}" subtitle="">
                    <form  id="add_customer_form">
                        ...
                        <div class="row">
                            ...
                            style="@error('name'){{ 'border-bottom: 2px solid red; padding-left: 10px!important'}} @enderror">
                        </div>
                        <div class="col-md-3 form-group bmd-form-group">
                            <label class="bmd-label-floating">Email</label>
                            <input id="customer_email"  type="email" name="email" class="form-control" value="{{old('email')}}"
                            style="@error('email'){{ 'border-bottom: 2px solid red; padding-left: 10px!important'}} @enderror">
                        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <x-utilities.banner title="Customers">
